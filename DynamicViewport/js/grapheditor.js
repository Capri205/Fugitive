...
** Constructor takes a viewport object and a graph object. Both must exist
*/

class GraphEditor {

    constructor( viewport, graph, ctx ) {
    ...
    /* Empty the graph of all points and segments and reset variables
    **
    ** @param none
    ** @returns nothig
    **/
    ...
    */
    ...
    #processLeftClick( event ) {
        ...
        // get a point where we clicked taking into consideration current zoom
    ...
    */
    ...
    /* Handle mouse button click event
    ** looking for left and right button clicks for setting or removing a point
    **
    ** @param event - the event
    ** @returns - nothing
    ** @private
    ...
    */
    #handleMouseMove( event ) {
        ...
        this.mousePosition = viewport.getMousePosition( event  );

        // selected point needs coordinates updated if it's being dragged
        if ( this.dragging && this.selected != null ) {

            const currMousePos = this.viewport.getMousePosition( event );
            this.selected.x = currMousePos.x;
            this.selected.y = currMousePos.y;
            //this.selected.x = event.offsetX * this.viewport.zoom;
            //this.selected.y = event.offsetY * this.viewport.zoom;
